  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to EPS!</DialogTitle>
          <DialogDescription>
          <div className="flex items-center gap-3 my-2">
              <p className="flex items-center">
                ...
                <Link
                  ...
                  href="https://github.com/abdullah-w-21/eps-app"
                >
                  GitHub
                </Link>
              </p>
            ...
            The Exam Prep System is an AI-driven app that tailors real-time quizzes to users' needs, optimizing their study sessions. It offers personalized quizzes, tracks progress, and provides insights for efficient exam preparation. The user-friendly interface ensures a dynamic and personalized studying experience.
            </p>
            <hr />
